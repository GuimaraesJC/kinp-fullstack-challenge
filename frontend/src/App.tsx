          ...
          <div
            ...
            <ul className='lg:flex lg:gap-x-8 max-lg:space-y-2'>
              ...
              <li className='max-lg:border-b max-lg:py-3'><a href='javascript:void(0)'
                className='hover:text-[#007bff] text-gray-600 block font-bold text-[15px]'>Shop</a>
              </li>
              <li className='max-lg:border-b max-lg:py-3'><a href='javascript:void(0)'
                className='hover:text-[#007bff] text-gray-600 block font-bold text-[15px]'>Sale</a>
              </li>
              <li className='max-lg:border-b max-lg:py-3'><a href='javascript:void(0)'
                className='hover:text-[#007bff] text-gray-600 block font-bold text-[15px]'>Manage</a>
              </li>
            </ul>
          </div>
        </div>
